...
import {getAllPermisosByUsuario, CheckPermissionAndUser, createPermissionByUser} from '../controllers/permisosUsuariosController.js';
...
router.post('/create', createPermissionByUser)
